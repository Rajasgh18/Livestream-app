...
export const Search = () => {
    ...
    return (
        <form onSubmit={onSubmit} className="relative w-full lg:w-[400px] flex items-center">
            ...
            {value && <X onClick={onClear} className="absolute top-2.5 right-14 text-muted-foreground cursor-pointer hover:opacity-75 transition h-5 w-5"/>}
            <Button type="submit" size="sm" variant="secondary" className="rounded-l-none hover:opacity-75">
