        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-y-4 p-3">
            <div className="w-full">
                ...
                <Input
                    ...
                    className={cn(
                        "border-white/10 outline-1 focus-visible:ring-none focus-visible:ring-0 focus-visible:border-white",
                        (isFollowersOnly || isDelayed) && "rounded-t-none"
                    )}
                />
            </div>
            <div className="ml-auto">
                <Button type="submit" variant="primary" size="sm" disabled={false}>Chat</Button>
            </div>
        </form>
    );
};
