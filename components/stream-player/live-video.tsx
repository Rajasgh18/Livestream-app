...
export const LiveVideo = ({ participant }: LiveVideoProps) => {
    ...
    const handlFullscreenChange = () => {
        const isCurrentlyFullscreen = document.fullscreenElement !== null;
        setIsFullScreen(isCurrentlyFullscreen);
    };

    useEventListener("fullscreenchange", handlFullscreenChange, wrapperRef);
    ...
    return (
        <div ref={wrapperRef} className="relative h-full flex">
            ...
            <div className="absolute top-0 h-full w-full opacity-0 hover:opacity-100 transition-all duration-500">
